...
## Overview:
This repository will contain all scripts used to clean and standardize the temperature data from over 60 autonomous logging devices installed in the Florida Keys and Dry Tortugas.
