...
- There are 8 distinct patterns of date saved here, I will use their structure to convert them all to what we are loking for with the lubridate() package
...
write.csv(florida_keys_master_2026, "florida_keys_master_2025.csv", row.names = FALSE)
```
