...
-   It seems as though some of the files have data in only half of the columns. I'm going to try and group the data together

## Get all the data in the columns Date, Time Temp c, Site, StationID

```{r}
# Select where Date is not NA
noncremp_format_data <- combined_temp %>%
  filter(!is.na(Year))
```
